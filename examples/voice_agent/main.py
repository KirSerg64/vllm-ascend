...
def _build_engine(config: dict[str, Any]) -> Any:
    """Construct and return a vllm.AsyncLLM instance."""
    from vllm import AsyncLLM, EngineArgs  # type: ignore[import]
    ...
    logger.info("Initialising AsyncLLM: %s", engine_args.model)
